...
const whatsappMessage = 'Olá, Vitória! Vim pelo seu link e gostaria de saber mais sobre os produtos.';
...
const mainLinks = [
  ...
  },
  {
    ...
    url: `https://wa.me/5571992293834?text=${encodeURIComponent(whatsappMessage)}`,
    isInternal: false,
  },
  {
...
const SocialPage = () => {
  // Esta página não trava o scroll do body: o conteúdo (perfil + 4 botões +
  // rodapé) passa da altura da viewport, e travar deixava a logo do rodapé
  // cortada sem como alcançá-la.
  return (
